...
public class Trans {
    ...
    private final Map<String, String> fullz2p;
    ...
    private void initZhuyin() {
        ...
        String[] fullzhuyin = new String[]{"ㄅㄧㄝ", "ㄅㄧㄠ", "ㄅㄧㄢ", "ㄅㄧㄣ", "ㄅㄧㄥ"  , "ㄅㄨ", "ㄅㄚ", "ㄅㄛ", "ㄅㄞ", "ㄅㄟ", "ㄅㄠ", "ㄅㄢ", "ㄅㄣ", "ㄅㄤ", "ㄅㄥ", "ㄅㄧ",
                "ㄆㄧㄝ", "ㄆㄧㄠ", "ㄆㄧㄢ", "ㄆㄧㄣ", "ㄆㄧㄥ", "ㄆㄨ", "ㄆㄚ", "ㄆㄛ", "ㄆㄞ", "ㄆㄟ", "ㄆㄠ", "ㄆㄡ", "ㄆㄢ", "ㄆㄣ", "ㄆㄤ", "ㄆㄥ", "ㄆㄧ",
                "ㄇㄧㄝ", "ㄇㄧㄠ", "ㄇㄧㄡ", "ㄇㄧㄢ", "ㄇㄧㄣ", "ㄇㄨ", "ㄇㄚ", "ㄇㄛ", "ㄇㄜ", "ㄇㄞ", "ㄇㄟ", "ㄇㄠ", "ㄇㄡ", "ㄇㄢ", "ㄇㄣ", "ㄇㄤ", "ㄇㄥ", "ㄇㄧ",
                "ㄈㄚ", "ㄈㄛ", "ㄈㄜ", "ㄈㄟ", "ㄈㄡ", "ㄈㄢ", "ㄈㄣ", "ㄈㄤ", "ㄈㄥ", "ㄈㄨ",
                "ㄉㄧㄝ", "ㄉㄧㄠ", "ㄉㄧㄡ", "ㄉㄧㄢ", "ㄉㄧㄥ",  "ㄉㄨㄛ", "ㄉㄨㄟ", "ㄉㄨㄢ", "ㄉㄨㄣ","ㄉㄚ", "ㄉㄜ", "ㄉㄞ", "ㄉㄟ", "ㄉㄠ", "ㄉㄡ", "ㄉㄢ", "ㄉㄣ", "ㄉㄤ", "ㄉㄥ", "ㄉㄧ","ㄉㄨ",
                "ㄊㄧㄝ", "ㄊㄧㄠ", "ㄊㄧㄢ", "ㄊㄧㄥ", "ㄊㄨㄛ", "ㄊㄨㄟ", "ㄊㄨㄢ", "ㄊㄨㄣ","ㄊㄚ", "ㄊㄜ", "ㄊㄞ", "ㄊㄠ", "ㄊㄡ", "ㄊㄢ", "ㄊㄤ", "ㄊㄥ", "ㄊㄧ","ㄊㄨ",
                "ㄋㄧㄝ", "ㄋㄧㄠ", "ㄋㄧㄡ", "ㄋㄧㄢ", "ㄋㄧㄣ", "ㄋㄧㄤ", "ㄋㄧㄥ",  "ㄋㄨㄛ", "ㄋㄨㄢ", "ㄋㄨㄣ", "ㄋㄨㄥ","ㄋㄚ", "ㄋㄜ", "ㄋㄞ", "ㄋㄟ", "ㄋㄠ", "ㄋㄡ", "ㄋㄢ", "ㄋㄣ", "ㄋㄤ", "ㄋㄥ", "ㄋㄧ","ㄋㄨ",
                "ㄌㄧㄚ", "ㄌㄧㄝ", "ㄌㄧㄠ", "ㄌㄧㄡ", "ㄌㄧㄢ", "ㄌㄧㄣ", "ㄌㄧㄤ", "ㄌㄧㄥ","ㄌㄨㄛ", "ㄌㄨㄢ", "ㄌㄨㄣ", "ㄌㄨㄥ", "ㄌㄩ", "ㄌㄩㄝ","ㄌㄚ", "ㄌㄛ", "ㄌㄜ", "ㄌㄞ", "ㄌㄟ", "ㄌㄠ", "ㄌㄡ", "ㄌㄢ", "ㄌㄣ", "ㄌㄤ", "ㄌㄥ", "ㄌㄧ", "ㄌㄨ",
                "ㄍㄨㄚ", "ㄍㄨㄛ", "ㄍㄨㄞ", "ㄍㄨㄟ", "ㄍㄨㄢ", "ㄍㄨㄣ", "ㄍㄨㄤ", "ㄍㄨㄥ","ㄍㄚ", "ㄍㄜ", "ㄍㄞ", "ㄍㄟ", "ㄍㄠ", "ㄍㄡ", "ㄍㄢ", "ㄍㄣ", "ㄍㄤ", "ㄍㄥ", "ㄍㄨ",
                "ㄎㄨㄚ", "ㄎㄨㄛ", "ㄎㄨㄞ", "ㄎㄨㄟ", "ㄎㄨㄢ", "ㄎㄨㄣ", "ㄎㄨㄤ", "ㄎㄨㄥ","ㄎㄚ", "ㄎㄜ", "ㄎㄞ", "ㄎㄠ", "ㄎㄡ", "ㄎㄢ", "ㄎㄣ", "ㄎㄤ", "ㄎㄥ", "ㄎㄨ",
                "ㄏㄨㄚ", "ㄏㄨㄛ", "ㄏㄨㄞ", "ㄏㄨㄟ", "ㄏㄨㄢ", "ㄏㄨㄣ", "ㄏㄨㄤ", "ㄏㄨㄥ","ㄏㄚ", "ㄏㄜ", "ㄏㄞ", "ㄏㄟ", "ㄏㄠ", "ㄏㄡ", "ㄏㄢ", "ㄏㄣ", "ㄏㄤ", "ㄏㄥ", "ㄏㄨ",
                "ㄐㄧㄚ", "ㄐㄧㄝ", "ㄐㄧㄠ", "ㄐㄧㄡ", "ㄐㄧㄢ", "ㄐㄧㄣ", "ㄐㄧㄤ", "ㄐㄧㄥ",  "ㄐㄩㄝ", "ㄐㄩㄢ", "ㄐㄩㄣ", "ㄐㄩㄥ","ㄐㄧ","ㄐㄩ",
                "ㄑㄧㄚ", "ㄑㄧㄝ", "ㄑㄧㄠ", "ㄑㄧㄡ", "ㄑㄧㄢ", "ㄑㄧㄣ", "ㄑㄧㄤ", "ㄑㄧㄥ",  "ㄑㄩㄝ", "ㄑㄩㄢ", "ㄑㄩㄣ", "ㄑㄩㄥ","ㄑㄧ","ㄑㄩ",
                "ㄒㄧㄚ", "ㄒㄧㄝ", "ㄒㄧㄠ", "ㄒㄧㄡ", "ㄒㄧㄢ", "ㄒㄧㄣ", "ㄒㄧㄤ", "ㄒㄧㄥ",  "ㄒㄩㄝ", "ㄒㄩㄢ", "ㄒㄩㄣ", "ㄒㄩㄥ","ㄒㄧ","ㄒㄩ",
                "ㄓㄨㄚ", "ㄓㄨㄛ", "ㄓㄨㄞ", "ㄓㄨㄟ", "ㄓㄨㄢ", "ㄓㄨㄣ", "ㄓㄨㄤ", "ㄓㄨㄥ", "ㄓㄚ", "ㄓㄜ", "ㄓㄞ", "ㄓㄟ", "ㄓㄠ", "ㄓㄡ", "ㄓㄢ", "ㄓㄣ", "ㄓㄤ", "ㄓㄥ", "ㄓㄨ", "ㄓ",
                "ㄔㄨㄚ","ㄔㄨㄛ", "ㄔㄨㄞ", "ㄔㄨㄟ", "ㄔㄨㄢ", "ㄔㄨㄣ", "ㄔㄨㄤ", "ㄔㄨㄥ", "ㄔㄚ", "ㄔㄜ", "ㄔㄞ", "ㄔㄠ", "ㄔㄡ", "ㄔㄢ", "ㄔㄣ", "ㄔㄤ", "ㄔㄥ", "ㄔㄨ", "ㄔ",
                "ㄕㄨㄚ", "ㄕㄨㄛ", "ㄕㄨㄞ", "ㄕㄨㄟ", "ㄕㄨㄢ", "ㄕㄨㄣ", "ㄕㄨㄤ","ㄕㄚ", "ㄕㄜ", "ㄕㄞ", "ㄕㄟ", "ㄕㄠ", "ㄕㄡ", "ㄕㄢ", "ㄕㄣ", "ㄕㄤ", "ㄕㄥ", "ㄕㄨ","ㄕ",
                "ㄖㄨㄛ", "ㄖㄨㄟ", "ㄖㄨㄢ", "ㄖㄨㄣ", "ㄖㄨㄥ","ㄖㄜ", "ㄖㄠ", "ㄖㄡ", "ㄖㄢ", "ㄖㄣ", "ㄖㄤ", "ㄖㄥ", "ㄖㄨ", "ㄖ",
                "ㄗㄨㄛ", "ㄗㄨㄟ", "ㄗㄨㄢ", "ㄗㄨㄣ", "ㄗㄨㄥ","ㄗㄚ", "ㄗㄜ", "ㄗㄞ", "ㄗㄟ", "ㄗㄠ", "ㄗㄡ", "ㄗㄢ", "ㄗㄣ", "ㄗㄤ", "ㄗㄥ", "ㄗㄨ",  "ㄗ",
                "ㄘㄨㄛ", "ㄘㄨㄟ", "ㄘㄨㄢ", "ㄘㄨㄣ", "ㄘㄨㄥ","ㄘㄚ", "ㄘㄜ", "ㄘㄞ", "ㄘㄠ", "ㄘㄡ", "ㄘㄢ", "ㄘㄣ", "ㄘㄤ", "ㄘㄥ", "ㄘㄨ","ㄘ",
                "ㄙㄨㄛ", "ㄙㄨㄟ", "ㄙㄨㄢ", "ㄙㄨㄣ", "ㄙㄨㄥ", "ㄙㄚ", "ㄙㄜ", "ㄙㄞ", "ㄙㄟ", "ㄙㄠ", "ㄙㄡ", "ㄙㄢ", "ㄙㄣ", "ㄙㄤ", "ㄙㄥ", "ㄙㄨ",  "ㄙ",
        ...
        String[] fullpinyin = new String[]{ "bie", "biao", "bian", "bin", "bing", "bu", "ba", "bo", "bai", "bei", "bao", "ban", "ben", "bang", "beng", "bi",
                "pie", "piao", "pian", "pin", "ping", "pu", "pa", "po", "pai", "pei", "pao", "pou", "pan", "pen", "pang", "peng", "pi",
                "mie", "miao", "miu", "mian", "min", "mu", "ma", "mo", "me", "mai", "mei", "mao", "mou", "man", "men", "mang", "meng", "mi",
                "fa", "fo", "fe", "fei", "fou", "fan", "fen", "fang", "feng", "fu",
                "die", "diao", "diu", "dian", "ding",  "duo", "dui", "duan", "dun","da", "de", "dai", "dei", "dao", "dou", "dan", "den", "dang", "deng", "di","du",
                "tie", "tiao", "tian", "ting",  "tuo", "tui", "tuan", "tun","ta", "te", "tai", "tao", "tou", "tan", "tang", "teng", "ti","tu",
                "nie", "niao", "niu", "nian", "nin", "niang", "ning",  "nuo", "nuan", "nun", "nung","na", "ne", "nai", "nei", "nao", "nou", "nan", "nen", "nang", "neng", "ni","nu",
                "lia", "lie", "liao", "liu", "lian", "lin", "liang", "ling", "luo", "luan", "lun", "lung", "lv", "lve","la", "lo", "le", "lai", "lei", "lao", "lou", "lan", "len", "lang", "leng", "li", "lu",
                "gua", "guo", "guai", "gui", "guan", "gun", "guang", "gong","ga", "ge", "gai", "gei", "gao", "gou", "gan", "gen", "gang", "geng", "gu",
                "kua", "kuo", "kuai", "kui", "kuan", "kun", "kuang", "kong","ka", "ke", "kai", "kao", "kou", "kan", "ken", "kang", "keng", "ku",
                "hua", "huo", "huai", "huai", "huan", "hun", "huang", "hong","ha", "he", "hai", "hei", "hao", "hou", "han", "hen", "hang", "heng", "hu",
                "jia", "jie", "jiao", "jiu", "jian", "jin", "jiang", "jing",  "jue", "juan", "jun", "jiong","ji","ju",
                "qia", "qie", "qiao", "qiu", "qian", "qin", "qiang", "qing",  "que", "quan", "qun", "qun",   "qi","qu",
                "xia", "xie", "xiao", "xiu", "xian", "xin", "xiang", "xing", "xue", "xuan", "xun", "xiong","xi","xu",
                "zhua", "zhuo", "zhuai", "zhuo", "zhuan", "zhuan", "zhuan", "zhong", "zha", "zhe", "zhai", "zhei", "zhao", "zhou", "zhan", "zhen", "zhang", "zheng", "zhu", "zhi",
                "chua", "chuo", "chuai", "chui", "chuan", "chun", "chuang", "chong", "cha", "che", "chai", "chao", "chou", "chan", "chen", "chang", "cheng", "chu","chi",
                "shua", "shuo", "shuai", "shui", "shuan", "shun", "shuang", "sha", "she", "shai", "shei", "shao", "shou", "shan", "shen", "shang", "sheng", "shu","shi",
                "ruo", "rui", "ruan", "run", "rung",  "re", "rao", "rou", "ran", "ren", "rang", "reng", "ru", "ri",
                "zuo", "zui", "zuan", "zun", "zong", "za", "ze", "zai", "zei", "zao", "zou", "zan", "zen", "zang", "zeng", "zu", "zi",
                "cuo", "cui", "cuan", "cun", "cong", "ca", "ce", "cai", "cao", "cou", "can", "cen", "cang", "ceng", "cu", "ci",
                "suo", "sui", "suan", "sun", "song", "sa", "se", "sai", "sei", "sao", "sou", "san", "sen", "sang", "seng", "su", "si",
                "ya","yo","ye","yai","yao","you","yan","yin","yang","ying",
                "wa","wo","wai","wei","wan","wen","wang","weng",
                "yue","yuan","yun","yong",
                "","b", "p", "m", "f", "d", "t", "n", "l", "g", "k", "h", "j", "q", "x", "zhi", "chi", "shi", "ri", "zi", "ci", "si", "a", "o", "e", "e", "ai", "ei", "ao", "ou", "an", "en", "ang", "eng", "er", "yi", "wu", "yu"
        };
        for (int i = 0, n = fullzhuyin.length; i < n; ++i) {
            fullz2p.put(fullzhuyin[i], fullpinyin[i]);
        }
    ...
    private String get(String text) {
        ...
        String[] fullZhuyins = text.split("↩");

        if (fullZhuyins.length > 1)
        {
            for (String fullZhuyin : fullZhuyins) {
                 String found = fullz2p.get(String.valueOf(fullZhuyin));
                 sb.append(found != null ? found : fullZhuyin);
            }
        } else {
